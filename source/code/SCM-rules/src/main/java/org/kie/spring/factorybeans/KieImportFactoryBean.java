...
public class KieImportFactoryBean
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        //customized for genscript.com 2016/06/07
        regesiterKieContainer(beanFactory);
    ...
    private void regesiterKieContainer(ConfigurableListableBeanFactory configurableListableBeanFactory){
    	if (releaseId != null){
    		String kContainerBeanName = releaseId.getGroupId() + "#" + releaseId.getArtifactId() + "#" + releaseId.getVersion();
